...
function Main() {
  return (
    <div className=' w-full h-[33.3em] overflow-hidden flex row pl-32 pr-16'>
...
<div className=' overflow-hidden w-8/12 gap-4 gap-x-6 grid-cols-2 grid-row-6 grid h-[33em] -mt-2'>
  {/* poster */}
  <div className='p'><Poster img='spider man miles morales' textbottom='19'/></div> 
  <div className='b'><Poster img='doom eternal' textbottom='33'/></div> 
  <div className='g'><Poster img='the last of us part 2' textbottom='22'/></div> 
  <div className='r'><Poster img='cyberpunk2077' textbottom='33'/></div> 
{/* poster end */}
</div>
    </div>
  )
